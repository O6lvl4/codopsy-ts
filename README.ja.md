...
<p align="center">
  ...
  <b>品質スコア</b>（A&ndash;F）、<b>循環的 &amp; 認知的複雑度</b>、<b>47 の lint ルール</b>、<br>
...
- **複雑度** (0&ndash;35) &mdash; cyclomatic > 10 (&times;2, 上限15/関数)、cognitive > 15 (&times;1.5, 上限12/関数)
- **課題** (0&ndash;40) &mdash; error: -8&times;件数、warning: -4&times;&radic;件数、info: -1&times;&radic;件数（ルール別集計、&radic;で逓減）
- **構造** (0&ndash;25) &mdash; max-lines (-10, 上限12)、max-depth (-4, 上限12)、max-params (-3, 上限10)
...
- **LSP / IDE 連携** &mdash; VS Code 拡張によるリアルタイム診断
- **ルールドキュメントサイト** &mdash; 各ルールの説明・設定例・根拠を掲載するリファレンスページ
